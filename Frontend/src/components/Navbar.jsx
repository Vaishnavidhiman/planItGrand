      ...
      >
        <div className="navbar ">
          <div className="navbar-start ">
            ...
            <a className=" text-3xl font-bold cursor-pointer">Plan It Grand</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className="px-3 py-2  hover:border-[1px] duration-300 cursor-pointer flex items-center gap-2">
                <input
                  type="text"
